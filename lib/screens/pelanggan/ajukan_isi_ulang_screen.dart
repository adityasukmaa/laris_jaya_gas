...
//           .length;
//       stokTabung[jenis.idJenisTabung.toString()] = stok;
//     }
//   }
...
//       final harga = selectedJenisTabungData.harga ?? 0.0; // Harga isi ulang, default to 0.0 if null
...
//           idStatusTabung: 1, // Tersedia, ganti dengan nilai int yang sesuai jika berbeda
...
//                       value: jenis.idJenisTabung.toString(),
//                       child: Text(
//                           '${jenis.namaJenis} (Stok Kosong: ${stokTabung[jenis.idJenisTabung.toString()] ?? 0})'),
//                     );
//                   }).toList(),
//                   onChanged: (value) {
//                     if (value != null) {
