...
class DetailTabungScreen extends StatelessWidget {
  ...
  DetailTabungScreen({super.key, required String idTabung});
...
// Simpan PDF ke direktori publik
      ...
      final fileName =
          '${kodeTabung}qrcode${DateTime.now().millisecondsSinceEpoch}.pdf';
  ...
  Future<void> _refreshGallery(String filePath) async {
    ...
    final platform = const MethodChannel('com.example.laris_jaya_gas/gallery');
    try {
...
// Panggil fetchTabungByKode saat layar dimuat
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Kode Tabung: ${tabung.kodeTabung ?? 'Unknown'}',
