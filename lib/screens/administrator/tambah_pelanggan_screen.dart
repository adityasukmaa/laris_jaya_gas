...
class TambahPelangganScreen extends StatelessWidget {
  ...
  final RxBool denganAkun = true.obs;
  ...
  TambahPelangganScreen({super.key}) {
    // Clear controllers on init
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      isPerusahaan.value = false;
      denganAkun.value = true;
    });
  }
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Obx(() => AnimatedOpacity(
                    opacity:
                        !isPerusahaan.value && denganAkun.value ? 1.0 : 0.0,
                    duration: const Duration(milliseconds: 300),
                    child: !isPerusahaan.value
                        ? _buildAkunSwitch()
                        : const SizedBox.shrink(),
          ...
          child: Obx(() => ElevatedButton(
            ...
            if (_formKey.currentState!.validate()) {
              ...
              colorText: AppColors.white,
                ...
                // Cek jika error 422 dan pesan email sudah digunakan
